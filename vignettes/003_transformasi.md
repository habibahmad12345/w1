...
# value untuk menampung nilai observasi
...
table4b_tidy <- table4b %>% 
   gather(key = "year", value ="population", 2:3) #menggunakan tydverse syntax
table4b_tidy
```
...
1. Melakukan proses gather atau memperbaiki data dengan membuat variabel year dan case
2. Melakukan pemilihan data hanya data country, year dan case
3. Dilakukan proses gruping berdasarkan country dan year dan diurutin
4. Dilakukan proses summarisasi dari penjumlahan case
5. dilakukan proses ungroup data 
6. Dilakukan proses join pada data population
7. Dilakukan proses filtering data yang na untuk populasi akan tidak dipilih
8. Dilakukan proses perhitungan mutate proporsi data
